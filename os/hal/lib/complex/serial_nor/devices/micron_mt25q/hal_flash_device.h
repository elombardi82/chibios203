 ...
 * @brief   Micron MT25Q serial flash driver header.
 *
 ...
 * @{
 */
#define MT25Q_SUPPORTED_MANUFACTURE_IDS    {0x20}
#define MT25Q_SUPPORTED_MEMORY_TYPE_IDS    {0xBA, 0xBB}
#define MT25Q_SUPPORTED_MEMORY_CAPACITIES  {0xBA, 0x21, 0x20, \
                                            0x19, 0x18, 0x17}
/** @} */
 ...
 * @{
 */
#define MT25Q_FLAGS_PROGRAM_ERASE                  0x80U
#define MT25Q_FLAGS_ERASE_SUSPEND                  0x40U
#define MT25Q_FLAGS_ERASE_ERROR                    0x20U
#define MT25Q_FLAGS_PROGRAM_ERROR                  0x10U
#define MT25Q_FLAGS_RESERVED                       0x08U
#define MT25Q_FLAGS_PROGRAM_SUSPEND                0x04U
#define MT25Q_FLAGS_PROTECTION_ERROR               0x02U
#define MT25Q_FLAGS_ADDRESSING                     0x01U
#define MT25Q_FLAGS_ALL_ERRORS                 (MT25Q_FLAGS_ERASE_ERROR |   \
                                                MT25Q_FLAGS_PROGRAM_ERROR | \
                                                MT25Q_FLAGS_PROTECTION_ERROR)
/** @} */
 ...
 * @{
 */
#define MT25Q_BUS_MODE_WSPI1L              1U
#define MT25Q_BUS_MODE_WSPI2L              2U
#define MT25Q_BUS_MODE_WSPI4L              4U
/** @} */
 ...
 */
#if !defined(MT25Q_SWITCH_WIDTH) || defined(__DOXYGEN__)
#define MT25Q_SWITCH_WIDTH                 TRUE
#endif

/**
 * @brief   Device bus mode to be used.
 * #note    if @p MT25Q_SWITCH_WIDTH is @p FALSE then this is the bus mode
 *          that the device is expected to be using.
 * #note    if @p MT25Q_SWITCH_WIDTH is @p TRUE then this is the bus mode
 *          that the device will be switched in.
 * @note    This option is only valid in WSPI bus mode.
 */
#if !defined(MT25Q_BUS_MODE) || defined(__DOXYGEN__)
#define MT25Q_BUS_MODE                     MT25Q_BUS_MODE_WSPI4L
#endif
 ...
 */
#if !defined(MT25Q_NICE_WAITING) || defined(__DOXYGEN__)
#define MT25Q_NICE_WAITING                 TRUE
#endif

/**
 * @brief   Uses 4kB sub-sectors rather than 64kB sectors.
 */
#if !defined(MT25Q_USE_SUB_SECTORS) || defined(__DOXYGEN__)
#define MT25Q_USE_SUB_SECTORS              FALSE
#endif
 ...
 */
#if !defined(MT25Q_COMPARE_BUFFER_SIZE) || defined(__DOXYGEN__)
#define MT25Q_COMPARE_BUFFER_SIZE          32
#endif
 ...
 *          operations.
 */
#if !defined(MT25Q_READ_DUMMY_CYCLES) || defined(__DOXYGEN__)
#define MT25Q_READ_DUMMY_CYCLES            8
#endif
...
#if (MT25Q_COMPARE_BUFFER_SIZE & (MT25Q_COMPARE_BUFFER_SIZE - 1)) != 0
#error "invalid MT25Q_COMPARE_BUFFER_SIZE value"
#endif

#if (MT25Q_READ_DUMMY_CYCLES < 1) || (MT25Q_READ_DUMMY_CYCLES > 15)
#error "invalid MT25Q_READ_DUMMY_CYCLES value (1..15)"
#endif

#if (MT25Q_BUS_MODE == MT25Q_BUS_MODE_WSPI4L) || defined(__DOXYGEN__)
/**
...
#elif MT25Q_BUS_MODE == MT25Q_BUS_MODE_WSPI1L
...
#else
#error "invalid MT25Q_BUS_MODE setting"
#endif
