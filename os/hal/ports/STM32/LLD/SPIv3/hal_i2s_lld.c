...
void i2s_lld_init(void) {
  ...
  I2SD1.dmatx     = NULL;
#if STM32_I2S_RX_ENABLED(STM32_I2S_SPI1_MODE)
  I2SD1.rxdmamode = STM32_DMA_CR_PL(STM32_I2S_SPI1_DMA_PRIORITY) |
...
#endif
#if STM32_I2S_TX_ENABLED(STM32_I2S_SPI1_MODE)
  I2SD1.txdmamode = STM32_DMA_CR_PL(STM32_I2S_SPI1_DMA_PRIORITY) |
                    STM32_DMA_CR_PSIZE_HWORD |
                    STM32_DMA_CR_MSIZE_HWORD |
  ...
  I2SD2.dmatx     = NULL;
#if STM32_I2S_RX_ENABLED(STM32_I2S_SPI2_MODE)
  I2SD2.rxdmamode = STM32_DMA_CR_PL(STM32_I2S_SPI2_DMA_PRIORITY) |
                    STM32_DMA_CR_PSIZE_HWORD |
                    STM32_DMA_CR_MSIZE_HWORD |
                    STM32_DMA_CR_DIR_P2M |
                    STM32_DMA_CR_MINC |
...
#endif
#if STM32_I2S_TX_ENABLED(STM32_I2S_SPI2_MODE)
  I2SD2.txdmamode = STM32_DMA_CR_PL(STM32_I2S_SPI2_DMA_PRIORITY) |
                    STM32_DMA_CR_PSIZE_HWORD |
                    STM32_DMA_CR_MSIZE_HWORD |
                    STM32_DMA_CR_DIR_M2P |
                    STM32_DMA_CR_MINC |
  ...
  I2SD3.dmatx     = NULL;
#if STM32_I2S_RX_ENABLED(STM32_I2S_SPI3_MODE)
  I2SD3.rxdmamode = STM32_DMA_CR_PL(STM32_I2S_SPI3_DMA_PRIORITY) |
                    STM32_DMA_CR_PSIZE_HWORD |
                    STM32_DMA_CR_MSIZE_HWORD |
                    STM32_DMA_CR_DIR_P2M |
                    STM32_DMA_CR_MINC |
...
#endif
#if STM32_I2S_TX_ENABLED(STM32_I2S_SPI3_MODE)
  I2SD3.txdmamode = STM32_DMA_CR_PL(STM32_I2S_SPI3_DMA_PRIORITY) |
                    STM32_DMA_CR_PSIZE_HWORD |
                    STM32_DMA_CR_MSIZE_HWORD |
                    STM32_DMA_CR_DIR_M2P |
                    STM32_DMA_CR_MINC |
...
void i2s_lld_start(I2SDriver *i2sp) {
  ...
  if (i2sp->state == I2S_STOP) {
    ...
    if (&I2SD1 == i2sp) {
      ...
      i2sp->spi->CR1 = 0;
      i2sp->spi->CFG1 = SPI_CFG1_RXDMAEN;
#endif
#if STM32_I2S_TX_ENABLED(STM32_I2S_SPI1_MODE)
  ...
  /* Clear IFCR */
  i2sp->spi->IFCR = 0x0FF8;

  /*
   * TODO: handle?
   * Now fixed at MSB
   */
  //i2sp->spi->CFG2 = SPI_CFG2_LSBFRST;
}
...
void i2s_lld_start_exchange(I2SDriver *i2sp) {
  ...
  if (NULL != i2sp->dmarx) {
    ...
    dmaStreamSetPeripheral(i2sp->dmarx, &i2sp->spi->RXDR);
  ...
  if (NULL != i2sp->dmatx) {
    ...
    dmaStreamSetPeripheral(i2sp->dmatx, &i2sp->spi->TXDR);
...
void i2s_lld_stop_exchange(I2SDriver *i2sp) {
  ...
  if (NULL != i2sp->dmatx) {
    ...
    /* From the RM: To switch off the I2S, by clearing SPE, it is mandatory
       to wait for TXC = 1.*/
    while ((i2sp->spi->SR & (SPI_SR_TXC)) != SPI_SR_TXC);
  }
